...
if __name__ == "__main__":
    ...
    model = DDPG(
        ...
        verbose=1,
        tensorboard_log="./logs/shadowhand_ddpg_her_single/",
        policy_kwargs=dict(
    ...
    eval_callback = SuccessEvalCallback(
        eval_env=eval_env,
        eval_freq=190_000,  
        log_path="./logs/eval_success_single",
        n_eval_episodes=10,
        deterministic=True,
        render=False
    )
    ...
    model.save("ShadowHandTouchSensors_RL/src/model/ddpg_her_shadowhand_single_env")
